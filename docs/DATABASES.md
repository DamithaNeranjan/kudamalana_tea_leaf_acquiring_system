...
- Web advance signals are stored separately from real desktop advances. They preserve scope, supplier/line target, effective month, date given, suggested amount, amount, optional comment, per-supplier suggestion breakdown, signalling user, and signalling timestamp.
